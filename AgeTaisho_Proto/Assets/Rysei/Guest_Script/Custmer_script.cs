...
public class Custmer_script : MonoBehaviour
{
    //お客さんステータス---------------------------------
    float EatTime = 3;          //食べ終わるまでの時間
    float RowTime = 15;         //列に並んでいる時間
    float SitTime = 27;         //席に座っている時間
    int Mistake = 5;            //間違えた時の時間の減量

    float RandomMax = 5;    //ランダムの最大値を決める変数
    //-------------------------------------------------------
